...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMS.Domain.Entities.AuditTrail", b =>
                {
            ...
            modelBuilder.Entity("MMS.Domain.Entities.Product", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
            ...
            modelBuilder.Entity("MMS.Domain.Identities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)")
            ...
            modelBuilder.Entity("MMS.Domain.Entities.AuditTrail", b =>
                {
                    b.HasOne("MMS.Domain.Identities.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("MMS.Domain.Identities.ApplicationUser", b =>
                {
                    b.HasOne("MMS.Domain.Identities.ApplicationUser", "Superior")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MMS.Domain.Identities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
